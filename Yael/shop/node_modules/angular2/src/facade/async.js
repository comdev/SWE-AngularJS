...
var PromiseWrapper = (function () {
    ...
    PromiseWrapper.setTimeout = function (fn, millis) { return lang_1.global.setTimeout(fn, millis); };
    PromiseWrapper.clearTimeout = function (id) { lang_1.global.clearTimeout(id); };
    PromiseWrapper.setInterval = function (fn, millis) { return lang_1.global.setInterval(fn, millis); };
    PromiseWrapper.clearInterval = function (id) { lang_1.global.clearInterval(id); };
