...
import {Injector,
  ...
  resolveForwardRef,
  resolveBindings} from 'angular2/di';
import {Visibility,
...
export class ProtoElementInjector {
  ...
  static _createViewInjectorBindingData(bindings, bd) {
    ListWrapper.forEach(bindings[0].resolvedViewInjectables, (b) => ListWrapper.push(bd, new BindingData(b, SHADOW_DOM)));
  }
  constructor(parent, index, bd, distanceToParent, firstBindingIsComponent) {
    this.parent = parent;
    this.index = index;
